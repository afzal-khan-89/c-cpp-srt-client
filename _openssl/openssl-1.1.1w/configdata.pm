...
our %config = (
  ...
  openssldir => "/home/afzal/ingenic/work-space/ingenic-app/apps/srt_ingenic/_openssl/openssl-1.1.1w/install-mips",
  options => "--prefix=/home/afzal/ingenic/work-space/ingenic-app/apps/srt_ingenic/_openssl/open_ssl_static_lib --openssldir=/home/afzal/ingenic/work-space/ingenic-app/apps/srt_ingenic/_openssl/openssl-1.1.1w/install-mips no-asan no-async no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.34.0",
  perlargv => [ "linux-generic32", "--prefix=/home/afzal/ingenic/work-space/ingenic-app/apps/srt_ingenic/_openssl/open_ssl_static_lib", "--openssldir=/home/afzal/ingenic/work-space/ingenic-app/apps/srt_ingenic/_openssl/openssl-1.1.1w/install-mips", "no-shared", "no-async" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/afzal/ingenic/work-space/ingenic-app/apps/srt_ingenic/_openssl/open_ssl_static_lib",
  processor => "",
